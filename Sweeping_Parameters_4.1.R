# ----------------------------------
# Writing functions for equation and sweeping over parameters
# 01 Apr 2020
# HVC
# ----------------------------------
#
...
# S=cA^z describes a species-area relationship
...
} # end of Species-Area Curve
# ctrl-shift-return runs the whole function in memory
# ----------------------------------
...
# description: plots species area curves with parameter vales
...
# ----------------------------------
species_area_plot()
# confirm labels, parameter values printed at top. 
...
# generates a data frame as an output. Each row corresponds to a different combinations of variables: c and z pars

# ----------------------------------
# FUNCTION sa_output
# description: summary stats for species-area power function
# inputs: vector of predicted species richness values
# outputs: list of max-min and the coefficient of variation
####################################
...
# Loop through parameters and full with sa function

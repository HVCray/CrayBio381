...
# description: fits an ordinary least squares regression model
# inputs: x and y vectors of numeric; must be the same length
# outputs: entire model summary from fitting a linear model
####################################
...
# inputs: x and y vectors of numerics, the same length
